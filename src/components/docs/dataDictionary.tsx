                      ...
                      <table className="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody className="divide-y divide-gray-700">
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">_id</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">ObjectId</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">The unique identifier for the source ID, automatically generated by MongoDB.</td>
                          </tr>
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">index_id</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">String</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">The index identifier for the source ID.</td>
                          </tr>
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">source_id</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">String</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">The source identifier.</td>
                          </tr>
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">metadata</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">Object</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">Additional metadata for the source ID.</td>
                          </tr>
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">path</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">String</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">The path of the source ID.</td>
                          </tr>
                          <tr>
                            <td className="px-6 py-4 text-sm font-medium text-[#94949c]">type</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">String</td>
                            <td className="px-6 py-4 text-sm text-[#94949c]">The type of the source ID.</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
